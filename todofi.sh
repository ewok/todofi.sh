...
SHORTCUT_NEW=${TODOFI_SHORTCUT_NEW:-"Alt+a"}
SHORTCUT_DONE=${TODOFI_SHORTCUT_DONE:-"Alt+d"}
SHORTCUT_EDIT=${TODOFI_SHORTCUT_EDIT:-"Alt+e"}
SHORTCUT_SWITCH=${TODOFI_SHORTCUT_SWITCH:-"Alt+Tab"}
SHORTCUT_TERM=${TODOFI_SHORTCUT_TERM:-"Alt+t"}
SHORTCUT_FILTERS=${TODOFI_SHORTCUT_FILTERS:-"Alt+p"}
